...
import com.threewks.thundr.introspection.ClassIntrospectorTest.NoDefaultCtor;
import com.threewks.thundr.introspection.ClassIntrospectorTest.PrivateCtor;
import com.threewks.thundr.introspection.ClassIntrospectorTest.TestC;
import com.threewks.thundr.introspection.ClassIntrospectorTest.TestCA;
...
public class TypeIntrospectorTest {
	...
	public void shouldReturnTrueIfClassExistsFalseOtherwise() {
		...
		assertThat(TypeIntrospector.classExists("com.threewks.thundr.introspection.TypeIntrospector"), is(true));
	...
	public void shouldReturnTrueForIsAJavabeanIfIsANormalObjectWithANoArgsCtor() {
		...
		assertThat(TypeIntrospector.isAJavabean(NoDefaultCtor.class), is(false));
		assertThat(TypeIntrospector.isAJavabean(HttpMethod.class), is(false));
