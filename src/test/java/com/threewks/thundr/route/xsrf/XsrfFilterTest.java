...
public class XsrfFilterTest {
	...
	public void shouldPassWithMatchingXsrfTokensOnPost() {
		...
		assertThat(filter.before(req, resp), is(nullValue()));
	...
	@Test
	public void shouldAllowOverridingOfNames() {
		filter.cookieName = "COOKIE";
		filter.headerName = "HEADER";
		filter.requestPropertyName = "PROP";
		...
		assertThat(filter.before(req, resp), is(nullValue()));
		assertThat(req.getData("PROP"), is(notNullValue()));
	}
