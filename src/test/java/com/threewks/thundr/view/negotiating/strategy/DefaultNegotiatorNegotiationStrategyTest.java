...
public class DefaultNegotiatorNegotiationStrategyTest {
	...
	private Negotiator defaultNegotiator;
	...
	public void before() {
		...
		defaultNegotiator = new JsonNegotiator();
	}

	@SuppressWarnings("rawtypes")
	@Test
	public void shouldReturnTheDefaultNegotiator() {
		viewNegotiatorRegistry.setDefaultNegotiator(defaultNegotiator);
		Negotiator result = strategy.findNegotiator(req, view, viewNegotiatorRegistry);
		assertThat(result, is(defaultNegotiator));
	}

	@Test
	public void shouldReturnNullIfNoDefaultNegotiator() {
		Negotiator<?> result = strategy.findNegotiator(req, view, viewNegotiatorRegistry);
